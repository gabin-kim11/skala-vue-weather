    ...
    <div class="about-shell">
      <section class="about-hero glass">
        ...
        <aside class="live-window">
          <div class="live-label"><span></span>{{ dataSourceLabel }} · {{ locationMessage }}</div>
          <div class="live-weather">
            ...
            <small>{{ selectedCityInfo.name }}의 지금</small>
          </div>
          <WeatherCharacter
          ...
          />
          <span class="window-frame frame-x"></span>
          <span class="window-frame frame-y"></span>
        </aside>
      </section>
      ...
      <section class="trust-grid">
        <article class="data-card glass">
          ...
          <p>현재 날씨는 기상청 관측값을 우선 활용하고, 시간대별·주간 예보와 생활지수는 실시간 예보 데이터로 보완해요. 연결이 잠시 늦어져도 준비된 정보로 화면이 비지 않게 설계했습니다.</p>
          <dl>
            <div><dt>현재 날씨</dt><dd>기상청 실황 우선</dd></div>
            <div><dt>시간·주간 예보</dt><dd>Open-Meteo</dd></div>
            <div><dt>공기질</dt><dd>실시간 대기 데이터</dd></div>
          </dl>
        </article>
